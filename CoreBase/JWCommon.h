...
namespace JWENGINE
{
	...
	static const DWORD DEFAULT_COLOR_BACKGROUND = D3DCOLOR_XRGB(50, 50, 50);
	static const DWORD DEFAULT_COLOR_NORMAL = D3DCOLOR_XRGB(115, 115, 115);
	static const DWORD DEFAULT_COLOR_HOVER = D3DCOLOR_XRGB(150, 150, 150);
	static const DWORD DEFAULT_COLOR_PRESSED = D3DCOLOR_XRGB(80, 80, 255);
	static const DWORD DEFAULT_COLOR_DARK = D3DCOLOR_XRGB(20, 20, 160);
	static const DWORD DEFAULT_COLOR_BORDER = D3DCOLOR_XRGB(80, 80, 160);
