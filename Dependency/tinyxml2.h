...
{
    friend class XMLElement;
    // Gives access to SetEError and Push/PopDepth, but over-access for everything else.
...
public:
    ...
    */
	const char* EErrorStr() const;

    /// A (trivial) utility function that prints the EErrorStr() to stdout.
    void PrintEError() const;

    /// Return the line where the error occurred, or zero if unknown.
    int EErrorLineNum() const
    {
